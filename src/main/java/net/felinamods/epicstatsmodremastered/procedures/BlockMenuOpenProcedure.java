...
public class BlockMenuOpenProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (ExpManagerConfiguration.NO_KEYBIND.get() == true) {
			if (ExpManagerConfiguration.MENU_BLOCK.get() == true) {
				if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ForgeRegistries.BLOCKS.getValue(new ResourceLocation(((ExpManagerConfiguration.MENU_BLOCK_V.get())).toLowerCase(java.util.Locale.ENGLISH)))) {
