...
import net.felinamods.epicstatsmodremastered.procedures.MenuOpenProcedure;
...
public class KeyMenuMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			MenuOpenProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		EpicStatsModRemasteredMod.addNetworkMessage(KeyMenuMessage.class, KeyMenuMessage::buffer, KeyMenuMessage::new, KeyMenuMessage::handler);
	}
}
