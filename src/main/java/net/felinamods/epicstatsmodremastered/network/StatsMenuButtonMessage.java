...
import net.felinamods.epicstatsmodremastered.procedures.GoinfoProcedure;
...
public class StatsMenuButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 9) {
			...
			GoinfoProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		EpicStatsModRemasteredMod.addNetworkMessage(StatsMenuButtonMessage.class, StatsMenuButtonMessage::buffer, StatsMenuButtonMessage::new, StatsMenuButtonMessage::handler);
	}
}
