...
import net.felinamods.epicstatsmodremastered.network.StatsMenuButtonMessage;
...
public class StatsMenuScreen extends AbstractContainerScreen<StatsMenuMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("epic_stats_mod_remastered:textures/screens/stats_menu.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu.label_level"), -164, 75, -1, false);
		guiGraphics.drawString(this.font,

				LevelRenderProcedure.execute(entity), -132, 75, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu.label_exp"), -164, 87, -1, false);
		guiGraphics.drawString(this.font,

				PlayerExRenderProcedure.execute(entity), -140, 87, -1, false);
		if (WeightGUIRenderProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu.label_weight"), 32, 93, -1, false);
		if (WeightGUIRenderProcedure.execute(entity))
			guiGraphics.drawString(this.font,
		...
		if (WeightGUIRenderProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu.label_status"), 32, 108, -1, false);
		guiGraphics.drawString(this.font,
	...
	public void init() {
		super.init();
		button_exchange_exp = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_exchange_exp"), e -> {
			if (ExchangeRenderProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(0, x, y, z));
		...
		button_1 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_1"), e -> {
			if (Stat1onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(1, x, y, z));
		...
		button_11 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_11"), e -> {
			if (Stat2onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(2, x, y, z));
		...
		button_12 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_12"), e -> {
			if (Stat3onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(3, x, y, z));
		...
		button_13 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_13"), e -> {
			if (Stat4onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(4, x, y, z));
		...
		button_14 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_14"), e -> {
			if (Stat5onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(5, x, y, z));
		...
		button_15 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_15"), e -> {
			if (Stat6onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(6, x, y, z));
				StatsMenuButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		...
		button_16 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_16"), e -> {
			if (Stat7onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(7, x, y, z));
				StatsMenuButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		...
		button_17 = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_17"), e -> {
			if (Stat8onProcedure.execute()) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(8, x, y, z));
				StatsMenuButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		...
		button_empty = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu.button_empty"), e -> {
			if (true) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuButtonMessage(9, x, y, z));
				StatsMenuButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
