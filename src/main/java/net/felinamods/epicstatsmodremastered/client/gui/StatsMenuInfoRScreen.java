...
import net.felinamods.epicstatsmodremastered.network.StatsMenuInfoRButtonMessage;
...
public class StatsMenuInfoRScreen extends AbstractContainerScreen<StatsMenuInfoRMenu> {
	private final static HashMap<String, Object> guistate = StatsMenuInfoRMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_return;

	public StatsMenuInfoRScreen(StatsMenuInfoRMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("epic_stats_mod_remastered:textures/screens/stats_menu_info_r.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_attack_damage"), -23, -67, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_health"), -23, -47, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_armor"), -23, -27, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_spell_damage_an"), -23, -7, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_mana_and_spell"), -23, 13, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_attack_speed"), -23, 33, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_stamina"), -23, 53, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_increases_player_luck"), -23, 73, -1, false);
		if (WeightGUIRenderProcedure.execute(entity))
			guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_players_weight"), 37, 103, -1, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.label_stats_info"), 17, -97, -1, false);
	}

	@Override
	public void init() {
		super.init();
		button_return = Button.builder(Component.translatable("gui.epic_stats_mod_remastered.stats_menu_info_r.button_return"), e -> {
			if (true) {
				EpicStatsModRemasteredMod.PACKET_HANDLER.sendToServer(new StatsMenuInfoRButtonMessage(0, x, y, z));
				StatsMenuInfoRButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
